...
# C:\Users\Public\Executável  - inserir data final ou  deixar dentro programa MAIN
...
# dentro da função está o programa que executará toda a análise estatisca dos concursos lotofacil
    ...
    concurso_inicial = concurso_referencia   # passando o numero concurso que será analisado, se " " pega ultimo
