...
def carregar_dados_quina(arquivo_excel: str = None, limite_concursos: int = 300) -> pd.DataFrame:
    """
    ...
    if arquivo_excel is None:
        ...
        arquivo_excel = os.path.join(os.getcwd(), 'LoteriasExcel', 'Quina_edt.xlsx')
